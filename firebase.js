/* ═══════════ FIREBASE ═══════════ */
const _fbConfig={
    apiKey:"AIzaSyCajIa-eELPfrzeUSfDr7_Wp4xZgXF2q2k",
    authDomain:"fares-hanoot.firebaseapp.com",
    databaseURL:"https://fares-hanoot-default-rtdb.europe-west1.firebasedatabase.app",
    projectId:"fares-hanoot",
    storageBucket:"fares-hanoot.firebasestorage.app",
    messagingSenderId:"374945227306",
    appId:"1:374945227306:web:2d0bbad29bd7a276e65953"
};
...
window._trashList=()=>{
    ...
    return _allEvents.filter(e=>e.type==='VOID'&&live.has(e.id)).map(v=>{
        ...
        if(t){
            ...
            const typeMap={INVOICE_BUY:'فاتورة شراء',INVOICE_SELL:'فاتورة بيع',RAF:'رافيناج',DUBAI:'بيع دبي',DOLLAR:'دولار',GT:(dd.gtType==='give'?'تسليم':'استلام'),SHIP:'شحن',EXPENSE:'مصاريف',SETTLE:'تصفية',SETTLE_GSM:(dd.freeBuy?'شراء حر':'تصفية ذهب'),XFER:'تحويل',LOAN:'سلف',SELL:'بيع سبيكة',OPENING:'رصيد افتتاحي',DEBT_FIX:'ضبط رصيد',VOID:'حذف (استرجاع سابق)'};
